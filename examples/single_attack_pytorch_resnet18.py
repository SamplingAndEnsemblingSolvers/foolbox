...
def main() -> None:
    ...
    params = {"solver": "rk2", "solver_param": 0.5}
    ...
    # clean_acc = accuracy(fmodel, images, labels, **params)
    ...
    raw_advs, clipped_advs, success = attack(fmodel, images, labels, epsilons=epsilons, **params)
